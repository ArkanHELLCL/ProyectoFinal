      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-12">
          ...
          <Link
            ...
            className="bg-linear-to-br from-orange-50 to-orange-100 rounded-lg shadow-lg p-8 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 border border-orange-200"
          >
            <div className="flex flex-col items-center text-center">
          ...
          <Link
            ...
            className="bg-linear-to-br from-rose-50 to-rose-100 rounded-lg shadow-lg p-8 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 border border-rose-200"
          >
            <div className="flex flex-col items-center text-center">
        ...
        <div className="mt-6 bg-white rounded-lg shadow-md p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
              ...
              <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
                ...
                <button
                  ...
                  className="w-full px-3 py-2 bg-gray-500 hover:bg-gray-600 disabled:bg-gray-200 disabled:text-gray-400 disabled:cursor-not-allowed text-white text-sm font-medium rounded-lg shadow-sm transition-all duration-200"
                >
                  Limpiar
                </button>
              </div>
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                ...
                <button
                  ...
                  className="w-full px-3 py-2 bg-blue-500 hover:bg-blue-600 disabled:bg-gray-200 disabled:text-gray-400 disabled:cursor-not-allowed text-white text-sm font-medium rounded-lg shadow-sm transition-all duration-200"
                >
                  Limpiar
                </button>
              </div>
              ...
              <div className="bg-indigo-50 border border-indigo-200 rounded-lg p-4">
                ...
                <button
                  ...
                  className="w-full px-3 py-2 bg-indigo-500 hover:bg-indigo-600 disabled:bg-gray-200 disabled:text-gray-400 disabled:cursor-not-allowed text-white text-sm font-medium rounded-lg shadow-sm transition-all duration-200"
                >
                  Limpiar
                </button>
              </div>
          ...
          <div className="border-t border-gray-200 pt-4">
            <button
              ...
              disabled={conteoPorTipo.reales === 0 && conteoPorTipo.encuesta === 0 && conteoPorCalculo.normal === 0 && conteoPorCalculo.derecha === 0 && conteoPorCalculo.izquierda === 0}
              className="w-full px-6 py-3 bg-red-500 hover:bg-red-600 disabled:bg-gray-200 disabled:text-gray-400 disabled:cursor-not-allowed text-white font-semibold rounded-lg shadow-md transition-all duration-200 hover:shadow-lg"
            >
